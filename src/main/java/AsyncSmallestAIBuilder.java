...
import ai.smallest.core.Environment;
import ai.smallest.core.LogConfig;
...
public class AsyncSmallestAIBuilder {
  ...
  private String apiKey = System.getenv("SMALLEST_API_KEY");
  ...
  /**
   * Sets apiKey.
   * Defaults to the SMALLEST_API_KEY environment variable.
   */
  public AsyncSmallestAIBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public AsyncSmallestAIBuilder environment(Environment environment) {
   ...
   */
  public AsyncSmallestAIBuilder timeout(int timeout) {
   ...
   */
  public AsyncSmallestAIBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncSmallestAIBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public AsyncSmallestAIBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public AsyncSmallestAIBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public AsyncSmallestAIBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncSmallestAIBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncSmallestAIBuilder addHeader(String name, String value) {
  ...
  public AsyncSmallestAI build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey or set the SMALLEST_API_KEY environment variable.");
    }
    validateConfiguration();
    return new AsyncSmallestAI(buildClientOptions());
  }
}
