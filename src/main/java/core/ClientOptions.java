...
public final class ClientOptions {
  ...
  private ClientOptions(Environment environment, Map<String, String> headers,
      ...
      Optional<Double> retryJitterFactor, Optional<WebSocketFactory> webSocketFactory,
      Optional<LogConfig> logging) {
    this.environment = environment;
    this.headers = new HashMap<>();
    this.headers.putAll(headers);
    this.headers.putAll(new HashMap<String,String>() {{put("X-Fern-Language", "JAVA");put("X-Fern-SDK-Name", "com.smallest-ai.fern:api-sdk");put("X-Fern-SDK-Version", "0.0.37");}});
  ...
  public static class Builder {
    ...
    public ClientOptions build() {
      ...
      return new ClientOptions(environment, headers, headerSuppliers, httpClient, this.timeout.get(), this.maxRetries, this.initialRetryDelayMillis, this.maxRetryDelayMillis, this.retryJitterFactor, this.webSocketFactory, this.logging);
    }
