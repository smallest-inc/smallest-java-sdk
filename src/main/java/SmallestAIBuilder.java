...
public class SmallestAIBuilder {
   ...
   */
  public SmallestAIBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public SmallestAIBuilder environment(Environment environment) {
   ...
   */
  public SmallestAIBuilder timeout(int timeout) {
   ...
   */
  public SmallestAIBuilder maxRetries(int maxRetries) {
   ...
   */
  public SmallestAIBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public SmallestAIBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public SmallestAIBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public SmallestAIBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public SmallestAIBuilder logging(LogConfig logging) {
   ...
   */
  public SmallestAIBuilder addHeader(String name, String value) {
