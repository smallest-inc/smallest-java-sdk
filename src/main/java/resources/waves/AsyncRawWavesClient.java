...
public class AsyncRawWavesClient {
  protected final ClientOptions clientOptions;

  public AsyncRawWavesClient(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<SmallestAIHttpResponse<List<PronunciationDict>>> getPronunciationDicts(
      ) {
  ...
  public CompletableFuture<SmallestAIHttpResponse<List<PronunciationDict>>> getPronunciationDicts(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
      ...
      CompletableFuture<SmallestAIHttpResponse<List<PronunciationDict>>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<PronunciationDict>>() {}), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<SmallestAIHttpResponse<PronunciationDict>> createPronunciationDict(
    ...
    public CompletableFuture<SmallestAIHttpResponse<PronunciationDict>> createPronunciationDict(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
        ...
        CompletableFuture<SmallestAIHttpResponse<PronunciationDict>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PronunciationDict.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<SmallestAIHttpResponse<UpdatePronunciationDictResponse>> updatePronunciationDict(
      ...
      public CompletableFuture<SmallestAIHttpResponse<UpdatePronunciationDictResponse>> updatePronunciationDict(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
          ...
          CompletableFuture<SmallestAIHttpResponse<UpdatePronunciationDictResponse>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdatePronunciationDictResponse.class), response));
                  return;
                }
                try {
                  switch (response.code()) {
         ...
         */
        public CompletableFuture<SmallestAIHttpResponse<DeletePronunciationDictResponse>> deletePronunciationDict(
        ...
        public CompletableFuture<SmallestAIHttpResponse<DeletePronunciationDictResponse>> deletePronunciationDict(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
            ...
            CompletableFuture<SmallestAIHttpResponse<DeletePronunciationDictResponse>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeletePronunciationDictResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
           ...
           */
          public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightning(
           ...
           */
          public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightning(
              LightningRequest request, RequestOptions requestOptions) {
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
              ...
              CompletableFuture<SmallestAIHttpResponse<InputStream>> future = new CompletableFuture<>();
              client.newCall(okhttpRequest).enqueue(new Callback() {
                @Override
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try {
                    ...
                    if (response.isSuccessful()) {
                      future.complete(new SmallestAIHttpResponse<>(new ResponseBodyInputStream(response), response));
                      return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
             ...
             * Get speech for given text using the Waves API
             */
            public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningLarge(
            ...
            public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningLarge(
               ...
               * Get speech for given text using the Waves API
               */
              public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningV2(
              ...
              public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningV2(
                 ...
                 * </ol>
                 */
                public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningLarge(
                    LightningLargeRequest request) {
                ...
                public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningLarge(
                  ...
                  HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                    ...
                    CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> future = new CompletableFuture<>();
                    client.newCall(okhttpRequest).enqueue(new Callback() {
                      @Override
                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        try {
                          ResponseBody responseBody = response.body();
                          if (response.isSuccessful()) {
                            future.complete(new SmallestAIHttpResponse<>(Stream.fromSse(Object.class, new ResponseBodyReader(response)), response));
                            return;
                          }
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          try {
                   ...
                   * </ol>
                   */
                  public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningV2(
                      Lightningv2Request request) {
                  ...
                  public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningV2(
                     ...
                     */
                    public CompletableFuture<SmallestAIHttpResponse<GetVoicesWavesResponse>> getVoices(
                    ...
                    public CompletableFuture<SmallestAIHttpResponse<GetVoicesWavesResponse>> getVoices(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                        ...
                        CompletableFuture<SmallestAIHttpResponse<GetVoicesWavesResponse>> future = new CompletableFuture<>();
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          @Override
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetVoicesWavesResponse.class), response));
                                return;
                              }
                              try {
                                switch (response.code()) {
                       ...
                       */
                      public CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> addVoice(
                          File file, AddVoiceWavesRequest request) {
                       ...
                       */
                      public CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> addVoice(
                          File file, AddVoiceWavesRequest request, RequestOptions requestOptions) {
                        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                          ...
                          CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> future = new CompletableFuture<>();
                          client.newCall(okhttpRequest).enqueue(new Callback() {
                            @Override
                            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                              try (ResponseBody responseBody = response.body()) {
                                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                if (response.isSuccessful()) {
                                  future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AddVoiceWavesResponse.class), response));
                                  return;
                                }
                                try {
                                  switch (response.code()) {
                          ...
                          public CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> addVoice(
                            ...
                            public CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> addVoice(
                              ...
                              public CompletableFuture<SmallestAIHttpResponse<AddVoiceWavesResponse>> addVoice(
                                 ...
                                 */
                                public CompletableFuture<SmallestAIHttpResponse<GetClonedVoicesWavesResponse>> getClonedVoices(
                                    ) {
                                ...
                                public CompletableFuture<SmallestAIHttpResponse<GetClonedVoicesWavesResponse>> getClonedVoices(
                                  ...
                                  HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                                    ...
                                    CompletableFuture<SmallestAIHttpResponse<GetClonedVoicesWavesResponse>> future = new CompletableFuture<>();
                                    client.newCall(okhttpRequest).enqueue(new Callback() {
                                      @Override
                                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                        try (ResponseBody responseBody = response.body()) {
                                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                          if (response.isSuccessful()) {
                                            future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetClonedVoicesWavesResponse.class), response));
                                            return;
                                          }
                                          try {
                                            switch (response.code()) {
                                   ...
                                   */
                                  public CompletableFuture<SmallestAIHttpResponse<DeleteVoiceWavesResponse>> deleteVoice(
                                  ...
                                  public CompletableFuture<SmallestAIHttpResponse<DeleteVoiceWavesResponse>> deleteVoice(
                                    ...
                                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                                      ...
                                      CompletableFuture<SmallestAIHttpResponse<DeleteVoiceWavesResponse>> future = new CompletableFuture<>();
                                      client.newCall(okhttpRequest).enqueue(new Callback() {
                                        @Override
                                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                          try (ResponseBody responseBody = response.body()) {
                                            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                            if (response.isSuccessful()) {
                                              future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteVoiceWavesResponse.class), response));
                                              return;
                                            }
                                            try {
                                              switch (response.code()) {
                                     ...
                                     * </ul>
                                     */
                                    public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeTts(
                                        TtsRequest request) {
                                    ...
                                    public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeTts(
                                       ...
                                       * </ul>
                                       */
                                      public CompletableFuture<SmallestAIHttpResponse<Iterable<String>>> synthesizeSseTts(
                                          TtsRequest request) {
                                      ...
                                      public CompletableFuture<SmallestAIHttpResponse<Iterable<String>>> synthesizeSseTts(
                                        ...
                                        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                                          ...
                                          client = client.newBuilder().callTimeout(0, TimeUnit.SECONDS).build();
                                          CompletableFuture<SmallestAIHttpResponse<Iterable<String>>> future = new CompletableFuture<>();
                                          client.newCall(okhttpRequest).enqueue(new Callback() {
                                            @Override
                                            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                              try {
                                                ResponseBody responseBody = response.body();
                                                if (response.isSuccessful()) {
                                                  future.complete(new SmallestAIHttpResponse<>(Stream.fromSse(String.class, new ResponseBodyReader(response)), response));
                                                  return;
                                                }
                                                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                                try {
                                         ...
                                         * </ul>
                                         */
                                        public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningV31(
                                        ...
                                        public CompletableFuture<SmallestAIHttpResponse<InputStream>> synthesizeLightningV31(
                                           ...
                                           * </ul>
                                           */
                                          public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningV31(
                                              LightningV31Request request) {
                                          ...
                                          public CompletableFuture<SmallestAIHttpResponse<Iterable<Object>>> synthesizeSseLightningV31(
                                             ...
                                             * </ul>
                                             */
                                            public CompletableFuture<SmallestAIHttpResponse<TranscribePulseWavesResponse>> transcribePulse(
                                                byte[] body) {
                                            ...
                                            public CompletableFuture<SmallestAIHttpResponse<TranscribePulseWavesResponse>> transcribePulse(
                                              ...
                                              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getWavesURL()).newBuilder()
                                                ...
                                                CompletableFuture<SmallestAIHttpResponse<TranscribePulseWavesResponse>> future = new CompletableFuture<>();
                                                client.newCall(okhttpRequest).enqueue(new Callback() {
                                                  @Override
                                                  public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                                    try (ResponseBody responseBody = response.body()) {
                                                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                                      if (response.isSuccessful()) {
                                                        future.complete(new SmallestAIHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TranscribePulseWavesResponse.class), response));
                                                        return;
                                                      }
                                                      try {
                                                        switch (response.code()) {
