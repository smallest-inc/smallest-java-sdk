...
@JsonDeserialize(
    builder = GetPickupRateByNumberRequest.Builder.class
)
public final class GetPickupRateByNumberRequest {
  ...
  private GetPickupRateByNumberRequest(Optional<String> agentId, Optional<String> campaignId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetPickupRateByNumberRequest && equalTo((GetPickupRateByNumberRequest) other);
  }
  ...
  private boolean equalTo(GetPickupRateByNumberRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(GetPickupRateByNumberRequest other) {
    ...
    public GetPickupRateByNumberRequest build() {
      return new GetPickupRateByNumberRequest(agentId, campaignId, callType, dateFrom, dateTo, additionalProperties);
    }
