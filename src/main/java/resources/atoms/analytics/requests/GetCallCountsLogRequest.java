...
@JsonDeserialize(
    builder = GetCallCountsLogRequest.Builder.class
)
public final class GetCallCountsLogRequest {
  ...
  private GetCallCountsLogRequest(Optional<String> agentId, Optional<String> campaignId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetCallCountsLogRequest && equalTo((GetCallCountsLogRequest) other);
  }
  ...
  private boolean equalTo(GetCallCountsLogRequest other) {
    return agentId.equals(other.agentId) && campaignId.equals(other.campaignId) && callType.equals(other.callType) && dateFrom.equals(other.dateFrom) && dateTo.equals(other.dateTo) && page.equals(other.page) && limit.equals(other.limit);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.agentId, this.campaignId, this.callType, this.dateFrom, this.dateTo, this.page, this.limit);
  }
  ...
  public static final class Builder {
    ...
    public Builder from(GetCallCountsLogRequest other) {
    ...
    public GetCallCountsLogRequest build() {
      return new GetCallCountsLogRequest(agentId, campaignId, callType, dateFrom, dateTo, page, limit, additionalProperties);
    }
