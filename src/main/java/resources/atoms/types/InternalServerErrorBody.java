...
public final class InternalServerErrorBody {
  ...
  private InternalServerErrorBody(Optional<Boolean> status, Optional<List<String>> errors,
  ...
  public static final class Builder {
    ...
    public InternalServerErrorBody build() {
      return new InternalServerErrorBody(status, errors, additionalProperties);
    }
