...
@JsonDeserialize(
    builder = ApiResponse.Builder.class
)
public final class ApiResponse {
  ...
  private ApiResponse(Optional<Boolean> status, Optional<Map<String, Object>> data,
  ...
  public static final class Builder {
    ...
    public ApiResponse build() {
      return new ApiResponse(status, data, additionalProperties);
    }
