...
@JsonDeserialize(
    builder = GetWebhookResponse.Builder.class
)
public final class GetWebhookResponse {
  private final Optional<Boolean> status;

  private final Optional<GetWebhookResponseData> data;

  private final Map<String, Object> additionalProperties;

  private GetWebhookResponse(Optional<Boolean> status, Optional<GetWebhookResponseData> data,
  ...
  @JsonProperty("data")
  public Optional<GetWebhookResponseData> getData() {
    return data;
  }
  ...
  public static final class Builder {
    ...
    private Optional<GetWebhookResponseData> data = Optional.empty();
    ...
    public Builder data(Optional<GetWebhookResponseData> data) {
      this.data = data;
      return this;
    }

    public Builder data(GetWebhookResponseData data) {
      this.data = Optional.ofNullable(data);
      return this;
    }

    public GetWebhookResponse build() {
      return new GetWebhookResponse(status, data, additionalProperties);
    }
